...
CREATE TABLE likes(
    ...
    from_users_likes_id BIGINT UNSIGNED NOT null,
    to_users_likes_id BIGINT UNSIGNED NOT null,
    created_at DATETIME DEFAULT NOW(),
    FOREIGN KEY (user_id) REFERENCES users(id),
    FOREIGN KEY (from_users_likes_id) REFERENCES users(id),
    FOREIGN KEY (to_users_likes_id) REFERENCES users(id),
